resource "aws_db_instance" "solirius_rds" {
  ...
  password                = aws_ssm_parameter.rds_secret.value
...
resource "aws_cloudwatch_metric_alarm" "rds_cpu_high" {
  ...
  dimensions = {
    DBInstanceIdentifier = aws_db_instance.solirius_rds.id
  }
...
resource "random_password" "dynamic_secret" {
...
resource "aws_ssm_parameter" "rds_secret" {
  ...
  value = random_password.dynamic_secret.result
}
